        ...
        <div className="container max-w-6xl mx-auto px-4">
          ...
          <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} className="text-center mt-10 flex flex-col items-center gap-4">
            <a
              ...
              className="group inline-flex items-center gap-3 h-14 px-7 rounded-xl text-white font-bold text-base transition-colors shadow-lg hover:shadow-xl bg-secondary-foreground"
            >
