    ...
    <div className="container max-w-6xl mx-auto px-4">
      ...
      <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
        ...
        >
          <img
            src={sectionImage}
            alt="Medico che usa piattaforma digitale"
            loading="lazy"
      ...
      <div className="grid md:grid-cols-2 gap-8">
        <motion.div
          ...
          className="rounded-2xl bg-card border border-destructive/20 p-8 space-y-4"
        >
        ...
        <motion.div
          ...
          className="rounded-2xl bg-card border border-primary/20 p-8 space-y-4 card-elevated"
        >
          <h3 className="font-extrabold text-xl text-foreground flex items-center gap-2">
